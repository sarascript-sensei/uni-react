...
import AddImage from './components/Building/AddImage';
import AddCabinetImage from './components/Cabinets/AddCabinetImage';
              ...
              <HeaderComponent />
                <div className="container">
                    <Switch> 
                          ...
                          <Route path = "/add-photo/" component = {AddImage}></Route>
                          ...
                          <Route path = "/view-cabinet" component = {ViewCabinetComponent}></Route>
                          <Route path = "/add-cabinet-photo/" component = {AddCabinetImage}></Route>
                    </Switch>
                </div>
              <FooterComponent />
        </Router>
